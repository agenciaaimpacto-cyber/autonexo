...
- **GitHub:** [github.com/agenciaaimpacto-cyber/autodirecto](https://github.com/agenciaaimpacto-cyber/autodirecto) (público). Repo creado manualmente por Danny desde la web de GitHub (sin `gh` CLI disponible en esta Mac) y conectado como `origin`: `https://github.com/agenciaaimpacto-cyber/autodirecto.git`.
...
4. **Nombre del repo de GitHub y del sitio/proyecto de Netlify siguen diciendo "autodirecto"** (`github.com/agenciaaimpacto-cyber/autodirecto`, `autodirecto.netlify.app`) — son renombrables desde la configuración de cada plataforma (GitHub redirige solo las URLs viejas al renombrar; Netlify permite cambiar el nombre del proyecto en Project configuration → General), pero requieren que Danny entre a esas cuentas. Si decide renombrarlos, no hace falta tocar nada más acá — el remoto de git sigue funcionando igual gracias al redirect de GitHub.
